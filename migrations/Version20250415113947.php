 ...
 */
final class Version20250415113947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE pack_service (pack_id INT NOT NULL, service_id INT NOT NULL, INDEX IDX_DAD40AAF1919B217 (pack_id), INDEX IDX_DAD40AAFED5CA9E6 (service_id), PRIMARY KEY(pack_id, service_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE pack_service ADD CONSTRAINT FK_DAD40AAF1919B217 FOREIGN KEY (pack_id) REFERENCES packevenement (pack_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE pack_service ADD CONSTRAINT FK_DAD40AAFED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id_service)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packservice DROP FOREIGN KEY FK_3F1EC8711919B217
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packservice DROP FOREIGN KEY FK_3F1EC871ED5CA9E6
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE packservice
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packevenement ADD image VARCHAR(255) NOT NULL, ADD date_disponibilite DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', DROP photo, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE prix prix NUMERIC(10, 2) NOT NULL, CHANGE nbre_invites_max nbre_invites_max INT DEFAULT NULL, CHANGE budget_prevu budget_prevu NUMERIC(10, 2) DEFAULT NULL, CHANGE date_evenement date_evenement DATE DEFAULT NULL, CHANGE date_creation date_creation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE date_modification date_modification DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE statut statut ENUM('actif', 'inactif', 'archivé'), CHANGE lieu type_evenement VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE packservice (pack_id INT NOT NULL, service_id INT NOT NULL, INDEX IDX_3F1EC8711919B217 (pack_id), INDEX IDX_3F1EC871ED5CA9E6 (service_id), PRIMARY KEY(pack_id, service_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = '' 
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packservice ADD CONSTRAINT FK_3F1EC8711919B217 FOREIGN KEY (pack_id) REFERENCES packevenement (pack_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packservice ADD CONSTRAINT FK_3F1EC871ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id_service)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE pack_service DROP FOREIGN KEY FK_DAD40AAF1919B217
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE pack_service DROP FOREIGN KEY FK_DAD40AAFED5CA9E6
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE pack_service
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packevenement ADD lieu VARCHAR(255) NOT NULL, ADD photo VARCHAR(255) DEFAULT NULL, DROP type_evenement, DROP image, DROP date_disponibilite, CHANGE description description LONGTEXT NOT NULL, CHANGE prix prix DOUBLE PRECISION NOT NULL, CHANGE nbre_invites_max nbre_invites_max INT NOT NULL, CHANGE budget_prevu budget_prevu DOUBLE PRECISION NOT NULL, CHANGE date_evenement date_evenement DATE NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE date_modification date_modification DATETIME NOT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
