 ...
 */
final class Version20250414205450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE comments CHANGE id_comment id_comment INT AUTO_INCREMENT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comments ADD CONSTRAINT FK_5F9E962AD1AA708F FOREIGN KEY (id_post) REFERENCES posts (id_post) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comments ADD CONSTRAINT FK_5F9E962A6B3CA4B FOREIGN KEY (id_user) REFERENCES user (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_post ON comments
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_5F9E962AD1AA708F ON comments (id_post)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_user ON comments
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_5F9E962A6B3CA4B ON comments (id_user)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE locaux DROP latitude, DROP longitude, CHANGE id_local id_local INT AUTO_INCREMENT NOT NULL, CHANGE photo photo LONGTEXT DEFAULT NULL, CHANGE equipement equipement LONGTEXT DEFAULT NULL, CHANGE tarifs tarifs NUMERIC(10, 2) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962AD1AA708F
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962A6B3CA4B
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962AD1AA708F
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comments CHANGE id_comment id_comment INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_5f9e962ad1aa708f ON comments
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX idx_post ON comments (id_post)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_5f9e962a6b3ca4b ON comments
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX idx_user ON comments (id_user)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comments ADD CONSTRAINT FK_5F9E962AD1AA708F FOREIGN KEY (id_post) REFERENCES posts (id_post) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE locaux ADD latitude DOUBLE PRECISION NOT NULL, ADD longitude DOUBLE PRECISION NOT NULL, CHANGE id_local id_local INT NOT NULL, CHANGE photo photo LONGTEXT NOT NULL, CHANGE equipement equipement LONGTEXT NOT NULL, CHANGE tarifs tarifs DOUBLE PRECISION NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packevenement CHANGE pack_id pack_id INT NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE prix prix DOUBLE PRECISION NOT NULL, CHANGE nbre_invites_max nbre_invites_max INT NOT NULL, CHANGE budget_prevu budget_prevu DOUBLE PRECISION NOT NULL, CHANGE date_evenement date_evenement DATE NOT NULL, CHANGE lieu lieu VARCHAR(255) NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE date_modification date_modification DATETIME NOT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL, CHANGE photo photo VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packevenement ADD CONSTRAINT FK_B69696F6AB213CC FOREIGN KEY (lieu_id) REFERENCES locaux (id_local) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
