 ...
 */
final class Version20250415114242 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE packevenement ADD lieu VARCHAR(255) NOT NULL, DROP date_disponibilite, CHANGE description description LONGTEXT NOT NULL, CHANGE prix prix DOUBLE PRECISION NOT NULL, CHANGE nbre_invites_max nbre_invites_max INT NOT NULL, CHANGE budget_prevu budget_prevu DOUBLE PRECISION NOT NULL, CHANGE date_evenement date_evenement DATE NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE date_modification date_modification DATETIME NOT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
