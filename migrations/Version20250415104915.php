 ...
 */
final class Version20250415104915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE packservice (pack_id INT NOT NULL, service_id INT NOT NULL, INDEX IDX_3F1EC8711919B217 (pack_id), INDEX IDX_3F1EC871ED5CA9E6 (service_id), PRIMARY KEY(pack_id, service_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
